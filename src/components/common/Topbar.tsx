...
const Topbar = () => {
  return (
    ...
    <div className="lg:w-[155px]">
      <a className="hidden md:block" href="./index.php"><img src="./img/logo.svg" alt="logo"/></a>
      <button className="mobile-menu-btn md:hidden">
        <svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 1H22M0 9.18519H22M0 18H22" stroke="black" strokeWidth="1.5"/>
        </svg>
      </button>
    </div>
    <div className="hidden lg:block">
      <h2 className="text-[#003F6C] font-semibold text-4xl leading-[54px] pl-[15px]">Dashboard</h2>
    </div>
    <div className="grow items-center flex justify-end lg:justify-center">
      <form className="hidden lg:flex max-w-[430px] grow rounded-[10px] bg-[#00000008] px-[15px] py-[19px] text-base placeholder:text-[#818B95] items-center justify-between">
        <input className="bg-transparent outline-none w-[calc(100%-23px)] pr-2" placeholder="Search"/>
        <button><img src="./img/icon-search.svg" alt=""/></button>
      </form>
      <button className="block lg:hidden mr-[22px]"><img src="./img/icon-search.svg" alt=""/></button>
    </div>
    <div className="flex items-center justify-center">
      <a href="./settings.php" className="mr-[22px] lg:mr-[37px] w-[37px] h-[37px] bg-[#F0F6F9] hover:bg-[#408FEF]/20 rounded-[10px] flex items-center justify-center"><img src="./img/icon-settings.svg" alt="icon-settings"/></a>
      <button className="flex text-sm text-[#3E3E3E] items-center relative thumbnail-btn">
        <div className="thumbnail-btn-inner border-[3px] border-transparent lg:mr-[17px] bg-[#B8C9D4] rounded-full w-[53px] text-white text-sm font-bold h-[53px] flex items-center justify-center">NK</div>
        <span className="hidden lg:inline">Username</span>
        <img className="hidden lg:inline ml-[15px]" src="./img/icon-arrow-down.svg" alt=""/>
        ...
        <div className="thumbnail-menu min-w-[280px] lg:min-w-[483px] absolute bg-[#F0F6F9] p-[12px] pb-[25px] rounded-[20px] button-shadow top-[70px] right-0 z-10 hidden">
          <div className="rounded-[15px] py-[16px] px-[19px] bg-white">
            <a href="" className="text-[#3E3E3E] font-semibold text-[16px] leading-[24px] mb-[30px] block">
              ...
              <img src="./img/thumbnail-icon.svg" className="w-[53px] h-[53px] mr-[23px]" alt="thubnail-icon"/>
              Username 1
              </div>
            </a>
            <a href="" className="text-[#3E3E3E] font-semibold text-[16px] leading-[24px] mb-[29px] block">
              <div className="flex items-center w-max">
              <img src="./img/thumbnail-icon.svg" className="w-[30px] h-[30px] ml-[11.5px] mr-[34.5px]"alt=""/>
              Username 2
              </div>
            </a>
            ...
            <a href="" className="text-[#3E3E3E] font-semibold text-[14px] leading-[21px] mt-[22.5px] block">
              <div className="flex items-center w-max">
              <svg className="w-[30px] h-[30px] ml-[20px] mr-[46.5px]" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="md:hidden">
    <h2 className="text-[#003F6C] font-semibold text-[24px] leading-[36px] pl-[23px] pb-[11px]">Dashboard</h2>
  </div>
    </>
  )
}
